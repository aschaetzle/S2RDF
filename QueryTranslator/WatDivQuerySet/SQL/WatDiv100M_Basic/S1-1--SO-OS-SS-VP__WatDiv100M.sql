SELECT tab0.v1 AS v1 , tab1.v0 AS v0 , tab6.v7 AS v7 , tab4.v5 AS v5 , tab3.v4 AS v4 , tab5.v6 AS v6 , tab2.v3 AS v3 , tab8.v9 AS v9 , tab7.v8 AS v8 
 FROM    (SELECT obj AS v0 
	 FROM gr__offers$$2$$ 
	 WHERE sub = 'wsdbm:Retailer8535' AND OSgr__includes=true AND OSgr__price=true AND OSgr__serialNumber=true AND OSgr__validFrom=true AND OSgr__validThrough=true AND OSsorg__eligibleQuantity=true AND OSsorg__eligibleRegion=true AND OSsorg__priceValidUntil=true
	) tab1
