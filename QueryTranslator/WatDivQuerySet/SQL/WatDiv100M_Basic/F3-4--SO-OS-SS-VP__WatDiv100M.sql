SELECT tab0.v1 AS v1 , tab2.v0 AS v0 , tab5.v5 AS v5 , tab4.v6 AS v6 , tab3.v4 AS v4 , tab1.v2 AS v2 
 FROM    (SELECT sub AS v0 
	 ...
	 WHERE obj = 'wsdbm:SubGenre143' AND SSsorg__contentRating=true AND SSsorg__contentSize=true AND SOwsdbm__purchaseFor=true
	) tab2
...
++++++Tables Statistic
wsdbm__purchaseDate$$5$$	1	VP	wsdbm__purchaseDate
