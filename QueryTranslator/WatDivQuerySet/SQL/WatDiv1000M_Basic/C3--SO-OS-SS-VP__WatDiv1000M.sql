SELECT tab0.v1 AS v1 , tab2.v0 AS v0 , tab4.v5 AS v5 , tab5.v6 AS v6 , tab3.v4 AS v4 , tab2.v3 AS v3 , tab1.v2 AS v2 
 FROM    (SELECT sub AS v0 , obj AS v3 
	 FROM dc__Location$$3$$ 
	 WHERE SSwsdbm__likes=true AND SSwsdbm__friendOf=true AND SSfoaf__age=true AND SSwsdbm__gender=true AND SSfoaf__givenName=true
	) tab2
 JOIN    (SELECT sub AS v0 , obj AS v4 
	 FROM foaf__age$$4$$ 
	 WHERE SSwsdbm__likes=true AND SSwsdbm__friendOf=true AND SSdc__Location=true AND SSwsdbm__gender=true AND SSfoaf__givenName=true
	) tab3
 ON(tab2.v0=tab3.v0)
 JOIN    (SELECT sub AS v0 , obj AS v5 
	 FROM wsdbm__gender$$5$$
	 
	 WHERE SSwsdbm__likes=true AND SSwsdbm__friendOf=true AND SSdc__Location=true AND SSfoaf__age=true AND SSfoaf__givenName=true
	) tab4
 ON(tab3.v0=tab4.v0)
 JOIN    (SELECT sub AS v0 , obj AS v6 
	 FROM foaf__givenName$$6$$
	 
	 WHERE SSwsdbm__likes=true AND SSwsdbm__friendOf=true AND SSdc__Location=true AND SSfoaf__age=true AND SSwsdbm__gender=true
	) tab5
 ON(tab4.v0=tab5.v0)
 JOIN    (SELECT obj AS v1 , sub AS v0 
	 FROM wsdbm__likes$$1$$ 
	 WHERE SSwsdbm__friendOf=true AND SSdc__Location=true AND SSfoaf__age=true AND SSwsdbm__gender=true AND SSfoaf__givenName=true
	) tab0
 ON(tab5.v0=tab0.v0)
 JOIN    (SELECT sub AS v0 , obj AS v2 
	 FROM wsdbm__friendOf$$2$$
	 
	 WHERE SSwsdbm__likes=true AND SSdc__Location=true AND SSfoaf__age=true AND SSwsdbm__gender=true AND SSfoaf__givenName=true
	) tab1
 ON(tab0.v0=tab1.v0)


++++++Tables Statistic
dc__Location$$3$$	1	VP	dc__Location
...
------
foaf__givenName$$6$$	1	VP	foaf__givenName
...
------
wsdbm__likes$$1$$	1	VP	wsdbm__likes
...
------
wsdbm__gender$$5$$	1	VP	wsdbm__gender
...
------
wsdbm__friendOf$$2$$	1	VP	wsdbm__friendOf
