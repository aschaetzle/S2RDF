SELECT tab7.v1 AS v1 , tab0.v0 AS v0 , tab8.v7 AS v7 , tab5.v5 AS v5 , tab6.v6 AS v6 , tab3.v4 AS v4 , tab1.v2 AS v2 , tab4.v8 AS v8 
 ...
 JOIN    (SELECT sub AS v0 
	 FROM og__tag$$3$$ 
	 WHERE obj = 'wsdbm:Topic105' AND SSfoaf__homepage=true AND SOgr__includes=true AND SSsorg__description=true AND SSsorg__contentSize=true AND SOwsdbm__likes=true
	) tab2
 ON(tab0.v0=tab2.v0)
